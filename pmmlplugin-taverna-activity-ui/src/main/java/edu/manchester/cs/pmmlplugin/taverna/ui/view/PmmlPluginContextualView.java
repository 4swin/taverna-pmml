package edu.manchester.cs.pmmlplugin.taverna.ui.view;
...
public class PmmlPluginContextualView extends ContextualView {
	...
	private String buildHtml() {
		...
		html.append("<tr><td width=25%>Version</td><td>-</td></tr>");
		html.append("<tr><td colspan=2><b>Provenance</b></td></tr>");
		html.append("<tr><td width=25%>Author</td><td>-</td></tr>");
		html.append("<tr><td width=25%>Copyright</td><td>-</td></tr>");
		html.append("<tr><td width=25%>Description</td><td>-</td></tr>");
		html.append("<tr><td width=25%>Application</td><td>-</td></tr>");
		html.append("<tr><td width=25%>Annotation</td><td>-</td></tr>");

...
import edu.manchester.cs.pmmlplugin.taverna.PmmlScoreLocalActivityConfigurationBean;
...
public class PmmlScoreLocalContextualView extends ContextualView {
	...
	private String buildHtml() {
		...
		html.append("<tr><td colspan=2><b>Input Dataset</b></td></tr>");
		html.append("<tr><td width=25%>Observations</td><td>0</td></tr>");
		html.append("<tr><td width=25%>Variables</td><td>0</td></tr>");
		html.append("<tr><td colspan=2><b>Scoring Engine</b></td></tr>");
		html.append("<tr><td width=25%>Target</td><td>"+configuration.getScoreEngine()+"</td></tr>");
